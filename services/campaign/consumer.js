...
const queueName = 'campaign'; // Bu servisin dinleyeceği kuyruk
...
amqp.connect(rabbitmqUrl, (err, connection) => {
  ...
  connection.createChannel((err, channel) => {
    ...
    console.log(`[*] campaign servisi ${queueName} kuyruğunu dinliyor...`);

    // Mesajları tüketme
    channel.consume(queueName, (msg) => {
      if (msg !== null) {
        const messageContent = msg.content.toString();
        console.log(`[x] campaign Mesaj alındı: ${messageContent}`);
