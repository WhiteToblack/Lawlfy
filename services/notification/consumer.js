...
const queueName = 'notification'; // Bu servisin dinleyeceği kuyruk
...
amqp.connect(rabbitmqUrl, (err, connection) => {
  ...
  connection.createChannel((err, channel) => {
    ...
    console.log(`[*] notification servisi ${queueName} kuyruğunu dinliyor...`);

    // Mesajları tüketme
    channel.consume(queueName, (msg) => {
      if (msg !== null) {
        const messageContent = msg.content.toString();
        console.log(`[x] notification Mesaj alındı: ${messageContent}`);
